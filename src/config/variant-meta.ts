...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  shiba: {
    title: 'Shiba Intelligence - Company External Signal Monitor',
    description: 'Private external-intelligence radar for AI, agent runtimes, generative media, social platforms, music, compute, policy, funding, and Shiba watchlist signals.',
    keywords: 'Shiba intelligence, AI model releases, agent runtimes, generative media, social platforms, music industry, creator economy, compute hardware, policy, grants, startup funding, external signals',
    url: 'http://127.0.0.1:4010/dashboard',
    siteName: 'Shiba Intelligence',
    shortName: 'ShibaIntel',
    subject: 'External Signals for Shiba Company OS',
    classification: 'Private Company Intelligence Dashboard',
    categories: ['news', 'business'],
    features: [
      'AI model and agent runtime monitoring',
      'Generative media and digital-human monitoring',
      'Social platform and music-industry monitoring',
      'China and Hong Kong technology monitoring',
      'Compute and creator-economy monitoring',
      'Policy, grant, funding, and watchlist discovery',
      'Source links and timestamps for traceability',
    ],
  },
  happy: {
